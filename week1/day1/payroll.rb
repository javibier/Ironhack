...
class Payroll
	...
	def notify_employee
		@employees.each do |employee| 
			puts "Dear #{employee.name}, you have been paid $#{employee.calculate_salary}"
...
daniel = Hourlyemployee.new("Daniel", "Daniel@gmail", 15, 40)
#puts daniel.calculate_salary

javier = Hourlyemployee.new("Javier", "Javier@gmail", 15, 40)
